            ...
            <div class="card-body">
              <div class="content">
                <div class="card-body ">
                  ...
                  <form action="/archaeologyAdmin" method="POST" enctype="multipart/form-data" >
                    {{ csrf_field() }}
                    @if (session('status'))
                    <div class="row">
                      <div class="col-sm-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                        <textarea name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('Type Description Here') }}"  rows="5" required ></textarea>
                        @if ($errors->has('Description'))
                          <span id="email-error" class="error text-danger" for="input-email">{{ $errors->first('description') }}</span>
                        @endif
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('location') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }}" name="location" id="input-name" type="text" placeholder="{{ __('Type Location URL Here') }}" required="true" aria-required="true"/>
