            ...
            <div class="card-body">
              <div class="content">
                <div class="card-body ">
                    ...
                    {!! Form::open(['action' => ['AechaeologyController@update',$archaeology->id], 'method'=>'POST','enctype'=>'multipart/form-data']) !!} 
                                       {{ csrf_field() }}
                                       {{ method_field('PUT') }}
                    @if (session('status'))
                    <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{$archaeology->title}}" name="title" id="input-name" type="text" placeholder="{{ __('Type Title Here') }}" required="true" aria-required="true"/>
                        @if ($errors->has('name'))
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                        {{Form::textarea('description',$archaeology->description,['class'=>'form-control','placeholder'=>"Enter Full Discriptions to Describe Archaeology"]) }}
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('location') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }}" name="location" value="{{$archaeology->location}}" id="input-name" type="text" placeholder="{{ __('Type Location URL Here') }}" required="true" aria-required="true"/>
                  ...
                  <button type="submit" name="submit" class="btn btn-primary btn-lrg" > Save Change </button>
