      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              ...
              <p class="card-category"> Here you can edit  city</p>
            </div>
            <div class="card-body">
              <div class="content">
                <div class="card-body ">

                    {!! Form::open(['action' => ['GovernorateController@update',$governorate->id], 'method'=>'POST','enctype'=>'multipart/form-data']) !!} 
                                       {{ csrf_field() }}
                                       {{ method_field('PUT') }}
                    @if (session('status'))
                    <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{$governorate->title}}" name="title" id="input-name" type="text" placeholder="{{ __('Type Title Here') }}" required="true" aria-required="true"/>
                        @if ($errors->has('name'))
